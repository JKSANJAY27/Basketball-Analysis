...
class TacticalViewDrawer:
    ...
    def draw(self, video_frames, court_image_path, width, height, tactical_court_keypoints, tactical_player_positions, player_assignment = None, ball_acquisition = None):
